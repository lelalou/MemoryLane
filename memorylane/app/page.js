...
export default function Home() {
  return (
    <>
      ...
      <div className=' relative top-20 left-60 w-200 h-100 bg-lightblue'>
        <img src="logo.png" className="flex justify-center" style={{ bottom: "0", width: '45%', height: '45%', objectFit: 'cover' }}/>

      </div>

      {/* <div  className='relative top-40 right-10 align center pt-10'>
...
<div className='px-80 pt-20 absolute top-1/2 transform -translate-y-1/2 text-center flex flex-row'>
      ...
      <div className='flex justify-center relative top-60 h-500'>
